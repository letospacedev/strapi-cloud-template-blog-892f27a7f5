...
export interface ApiCompanyCompany extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    CompanyID: Schema.Attribute.UID<''>;
...
export interface ApiSolutionSolution extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    SolutionDescription: Schema.Attribute.Text;
    SolutionDescriptionRich: Schema.Attribute.RichText;
    SolutionDescriptionRichJSON: Schema.Attribute.Blocks;
    SolutionID: Schema.Attribute.UID<''>;
    SolutionImage: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
